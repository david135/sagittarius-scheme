        ...
        SG_FOR_EACH(cgen_2,rest) {
          {
            ...
            if (!(SG_NUMBERP(x))) {
              Sg_WrongTypeOfArgumentViolation(SG_INTERN("\\x2B;."), Sg_MakeString(UC("number"), SG_LITERAL_STRING), x, SG_NIL);
              return SG_UNDEF;
;
            }
;
        ...
        SG_FOR_EACH(cgen_6,rest) {
          {
            ...
            if (!(SG_NUMBERP(x))) {
              Sg_WrongTypeOfArgumentViolation(SG_INTERN("\\x2D;."), Sg_MakeString(UC("number"), SG_LITERAL_STRING), x, SG_NIL);
              return SG_UNDEF;
;
            }
;
...
;
static SgObject nullassoc(SgObject *args, int argc, void *data_)
{
...
static SG_DEFINE_SUBR(nullassoc_Stub, 2, 0, nullassoc, SG_FALSE, NULL);
...
;
    {
      ...
      if (ch == EOF      ) {
        ...
        {
          SgChar* buf = SG_NEW_ATOMIC2(SgChar*, (count + 1));
          int i = 0;
...
static SgObject nullfxmax(SgObject *args, int argc, void *data_)
{
  ...
  retrieveOptionalArguments(1, rest);
  {
    int SG_RETURN;
    {
      ...
      {
        SgObject cgen_29;
        SG_FOR_EACH(cgen_29,rest) {
          {
            SgObject v = SG_CAR(cgen_29);
            if (!(SG_INTP(v))) {
...
static SgObject nullfxmin(SgObject *args, int argc, void *data_)
{
  ...
  retrieveOptionalArguments(1, rest);
  {
    int SG_RETURN;
    {
      ...
      {
        SgObject cgen_30;
        SG_FOR_EACH(cgen_30,rest) {
          {
            SgObject v = SG_CAR(cgen_30);
            if (!(SG_INTP(v))) {
              Sg_WrongTypeOfArgumentViolation(SG_INTERN("fxmac"), Sg_MakeString(UC("fixnum"), SG_LITERAL_STRING), v, SG_NIL);
              return SG_UNDEF;
;
...
;
        cgen_32=(fx1 - (cgen_32 * fx2));
;
        if (cgen_32 <= (abs(fx2) / 2)        ) {
          ret=cgen_31;
        } else if (fx2 > 0        ) {
          ret=(cgen_31 + 1);
        } else {
...
;
          if (fx1 == 0          ) {
            ...
            cgen_35=(((fx1 - fx2) + 1) / fx2);
          } else {
            cgen_35=((fx1 + fx2 + 1) / fx2);
          }
          
;
          cgen_35=(fx1 - (cgen_35 * fx2));
;
          if (cgen_35 <= (abs(fx2) / 2)          ) {
            cgen_33=cgen_34;
          } else if (fx2 > 0          ) {
            cgen_33=(cgen_34 + 1);
          } else {
...
;
        ...
        } else {
          {
            ...
            {
              SgObject cgen_46;
              SG_FOR_EACH(cgen_46,SG_CDR(rest)) {
                {
...
;
        ...
        } else {
          {
            ...
            {
              SgObject cgen_47;
              SG_FOR_EACH(cgen_47,SG_CDR(rest)) {
                {
...
;
    if (SG_NULLP(rest)) {
    ...
    } else {
      {
        ...
        {
          SgObject cgen_48;
          SG_FOR_EACH(cgen_48,rest) {
            {
              SgObject v = SG_CAR(cgen_48);
              if (!(SG_FLONUMP(v))) {
                Sg_WrongTypeOfArgumentViolation(SG_INTERN("fl-"), Sg_MakeString(UC("flonum"), SG_LITERAL_STRING), SG_LIST1(v), SG_NIL);
                return SG_UNDEF;
;
...
;
    } else {
      {
        ...
        {
          SgObject cgen_49;
          SG_FOR_EACH(cgen_49,rest) {
            {
              SgObject v = SG_CAR(cgen_49);
              if (!(SG_FLONUMP(v))) {
                Sg_WrongTypeOfArgumentViolation(SG_INTERN("fl/"), Sg_MakeString(UC("flonum"), SG_LITERAL_STRING), SG_LIST1(v), SG_NIL);
                return SG_UNDEF;
;
...
;
          cgen_52=(d1 - (d2 * cgen_53));
        }
;
        if (cgen_52 < (fabs(d2) / 2.0)        ) {
          ret=cgen_51;
        } else if (d2 > 0.0        ) {
          ret=(cgen_51 + 1.0);
        } else {
...
;
            cgen_56=(d1 - (d2 * cgen_57));
          }
;
          if (cgen_56 < (fabs(d2) / 2.0)          ) {
            cgen_54=cgen_55;
          } else if (d2 > 0.0          ) {
            cgen_54=(cgen_55 + 1.0);
          } else {
  ...
  retrieveOptionalArguments(1, rest);
  {
    ...
    if (SG_NULLP(rest)) {
    ...
    } else {
      {
        ...
        {
          SgObject cgen_59;
          SG_FOR_EACH(cgen_59,SG_CDR(rest)) {
            {
              SgObject v = SG_CAR(cgen_59);
              r=Sg_LogIor(r, v);
            }
          }
        }
  ...
  retrieveOptionalArguments(1, rest);
  {
    ...
    if (SG_NULLP(rest)) {
    ...
    } else {
      {
        ...
        {
          SgObject cgen_60;
          SG_FOR_EACH(cgen_60,SG_CDR(rest)) {
            {
              SgObject v = SG_CAR(cgen_60);
              r=Sg_LogXor(r, v);
            }
          }
        }
...
;
    {
      ...
      {
        SgObject cgen_61;
        SG_FOR_EACH(cgen_61,fields) {
          {
            SgObject field = SG_CAR(cgen_61);
...
void Sg__Initnull()
{
  ...
  SG_PROCEDURE_NAME(&nullassoc_Stub) = Sg_MakeString(UC("assoc"), SG_LITERAL_STRING);
  Sg_InsertBinding(lib, Sg_Intern(Sg_MakeString(UC("assoc"), SG_LITERAL_STRING)), SG_OBJ(&nullassoc_Stub));
