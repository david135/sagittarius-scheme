...
static SgObject regex_stub_compile_regex(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_STRINGP(p_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[0], SG_MAKE_STRING("string"), p_scm, SG_NIL);
  p = SG_STRING(p_scm);
  if (SG_ARGC > 1+1) {
  ...
  if (!SG_INTP(flags_scm) && !SG_INTP(flags_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[0], SG_MAKE_STRING("fixnum"), flags_scm, SG_NIL);
  ...
  if (!SG_FALSEP(parse_only_scm) && !SG_BOOLP(parse_only_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[0], SG_MAKE_STRING("boolean"), parse_only_scm, SG_NIL);
...
static SgObject regex_stub_dump_regex(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_PATTERNP(p_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[1], SG_MAKE_STRING("pattern"), p_scm, SG_NIL);
  p = SG_PATTERN(p_scm);
  if (SG_ARGC > 1+1) {
...
Sg_CurrentOutputPort();
  ...
  if (!SG_PORTP(port_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[1], SG_MAKE_STRING("port"), port_scm, SG_NIL);
...
static SgObject regex_stub_regex_matcher(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_PATTERNP(p_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[2], SG_MAKE_STRING("pattern"), p_scm, SG_NIL);
  p = SG_PATTERN(p_scm);
  text_scm = SG_ARGREF(1);
  if (!SG_STRINGP(text_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[2], SG_MAKE_STRING("string"), text_scm, SG_NIL);
...
static SgObject regex_stub_regex_matches(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[3], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
  {
{
...
static SgObject regex_stub_regex_looking_at(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[4], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
  {
{
int SG_RESULT = (int)NULL;
...
static SgObject regex_stub_regex_find(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[5], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
  if (SG_ARGC > 1+1) {
  ...
  if (!SG_INTP(start_scm) && !SG_INTP(start_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[5], SG_MAKE_STRING("fixnum"), start_scm, SG_NIL);
...
static SgObject regex_stub_regex_group(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[6], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
  if (SG_ARGC > 1+1) {
  ...
  if (!SG_INTP(group_scm) && !SG_INTP(group_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[6], SG_MAKE_STRING("fixnum"), group_scm, SG_NIL);
...
static SgObject regex_stub_regex_after(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[7], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
  {
{
SgObject SG_RESULT = (SgObject)NULL;
...
static SgObject regex_stub_regex_before(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[8], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
  {
{
SgObject SG_RESULT = (SgObject)NULL;
...
static SgObject regex_stub_regex_capture_count(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[9], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
  {
{
...
static SgObject regex_stub_regex_first(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[10], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
  {
{
long SG_RESULT = (long)NULL;
...
static SgObject regex_stub_regex_last(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[11], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
  {
{
long SG_RESULT = (long)NULL;
...
static SgObject regex_stub_regex_replace_all(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[12], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
...
Sg_WrongTypeOfArgumentViolation(sg__rc.d79[13],
...
static SgObject regex_stub_regex_replace_first(SgObject *SG_FP, int SG_ARGC, void *data_)
{
  ...
  if (!SG_MATCHERP(m_scm))
    Sg_WrongTypeOfArgumentViolation(
       sg__rc.d79[14], SG_MAKE_STRING("matcher"), m_scm, SG_NIL);
  m = SG_MATCHER(m_scm);
  replacement_scm = SG_ARGREF(1);
  replacement = (replacement_scm);
  {
...
void Sg__Init_sagittarius_regex_impl () {
  ...
  sg__rc.d79[0] = SG_MAKE_STRING("compile-regex");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[0]), &regex_stub_compile_regex__STUB);
  SG_PROCEDURE_NAME(&regex_stub_compile_regex__STUB) = sg__rc.d79[0];
  sg__rc.d79[1] = SG_MAKE_STRING("dump-regex");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[1]), &regex_stub_dump_regex__STUB);
  SG_PROCEDURE_NAME(&regex_stub_dump_regex__STUB) = sg__rc.d79[1];
  sg__rc.d79[2] = SG_MAKE_STRING("regex-matcher");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[2]), &regex_stub_regex_matcher__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_matcher__STUB) = sg__rc.d79[2];
  sg__rc.d79[3] = SG_MAKE_STRING("regex-matches");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[3]), &regex_stub_regex_matches__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_matches__STUB) = sg__rc.d79[3];
  sg__rc.d79[4] = SG_MAKE_STRING("regex-looking-at");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[4]), &regex_stub_regex_looking_at__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_looking_at__STUB) = sg__rc.d79[4];
  sg__rc.d79[5] = SG_MAKE_STRING("regex-find");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[5]), &regex_stub_regex_find__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_find__STUB) = sg__rc.d79[5];
  sg__rc.d79[6] = SG_MAKE_STRING("regex-group");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[6]), &regex_stub_regex_group__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_group__STUB) = sg__rc.d79[6];
  sg__rc.d79[7] = SG_MAKE_STRING("regex-after");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[7]), &regex_stub_regex_after__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_after__STUB) = sg__rc.d79[7];
  sg__rc.d79[8] = SG_MAKE_STRING("regex-before");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[8]), &regex_stub_regex_before__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_before__STUB) = sg__rc.d79[8];
  sg__rc.d79[9] = SG_MAKE_STRING("regex-capture-count");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[9]), &regex_stub_regex_capture_count__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_capture_count__STUB) = sg__rc.d79[9];
  sg__rc.d79[10] = SG_MAKE_STRING("regex-first");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[10]), &regex_stub_regex_first__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_first__STUB) = sg__rc.d79[10];
  sg__rc.d79[11] = SG_MAKE_STRING("regex-last");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[11]), &regex_stub_regex_last__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_last__STUB) = sg__rc.d79[11];
  sg__rc.d79[12] = SG_MAKE_STRING("regex-replace-all");
  sg__rc.d79[13] = Sg_Intern(sg__rc.d79[12]); /* regex-replace-all */
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[12]), &regex_stub_regex_replace_all__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_replace_all__STUB) = sg__rc.d79[12];
  sg__rc.d79[14] = SG_MAKE_STRING("regex-replace-first");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[14]), &regex_stub_regex_replace_first__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_replace_first__STUB) = sg__rc.d79[14];
  sg__rc.d79[15] = SG_MAKE_STRING("regex-pattern?");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[15]), &regex_stub_regex_patternP__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_patternP__STUB) = sg__rc.d79[15];
  sg__rc.d79[16] = SG_MAKE_STRING("regex-matcher?");
  Sg_InsertBinding(lib, Sg_Intern(sg__rc.d79[16]), &regex_stub_regex_matcherP__STUB);
  SG_PROCEDURE_NAME(&regex_stub_regex_matcherP__STUB) = sg__rc.d79[16];
}
